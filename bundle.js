...
},{"./pad-string":2,"buffer":6}],2:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    .then((messageListResponse) => messageListResponse.json()).then((messageListResponse) => {
      ...
      for (let index = 0; index < 10; index++) {
        ...
        .then((individualEmailResponse) => individualEmailResponse.json()).then((individualEmailResponse) => {
          ...
          // Convert this base64 variable to plain text
          // const base64Decoded = atob(base64Encoded);
          // let advancedDecoded = base64Encoded.replace(new RegExp('\\+','g'),'%2B');
          // advancedDecoded = unescape(advancedDecoded);
          // advancedDecoded = atob(advancedDecoded);
          let advancedDecoded = base64url.decode(base64Encoded);

          // console.log(base64Decoded);
          // console.log(advancedDecoded);
...
},{"base64url":3}],5:[function(require,module,exports){
'use strict'
